...
const Confirmation = () => {
    return (
        <div className="confirmation__wrap">
            ...
            <p className="confirmation__text">La solicitud de tus vacaciones: <span className="confirmation__date">13/09/2019</span> hasta <span className="confirmation__date">16/09/2019</span> ha sido enviada correctamente, en breve recibirás un mail con la confirmación. Si no recibes este mail ponte en contacto con tu jefe de proyecto.</p>
        </div>
    )
}
